...
assert fit.sha(original) == 'd20e532d4dab0777761007a967da3d897d0fa2ea3fab9fdc4b304e89f00cc364'
assert fit.sha(root) == '4f2a9673173a0c32b85a2b1256eaafab4ca96312f134df86e38ae1a58595a88e'
assert root[:4] == b'hsqs' and struct.unpack_from('<H', root, 20)[0] == 6
assert struct.unpack_from('<I', root, 12)[0] == 524288
...
manifest = {'image': a.output.name, 'bytes': len(image), 'sha256': fit.sha(image),
            ...
            'rootfs_compression': 'zstd', 'rootfs_level': 22, 'kernel_compression': 'lzo',
            ...
            'commit_requested': False, 'capacity_observation': 'previous hardware trial; recheck before flashing', 'payloads': record}
