...
root=$(head -c 75915264 /dev/ubi0_4 | sha256sum | cut -d ' ' -f 1)
...
test "$root" = 4f2a9673173a0c32b85a2b1256eaafab4ca96312f134df86e38ae1a58595a88e
...
test "$(cat /sys/class/ubi/ubi0/avail_eraseblocks)" = 20
