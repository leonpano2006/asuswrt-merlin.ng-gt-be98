...
test "$(sha256sum /tmp/leon36-rmerlin1029a2.pkgtb | cut -d ' ' -f 1)" = c00d37380488830d38e9d72019592ceb830cbd653f2caa50c1f8805a4869cbb8
test "$(wc -c < /tmp/leon36-rmerlin1029a2.pkgtb)" = 90840140
/bin/fc status | grep 'HW Acceleration <Enabled>'
echo RMERLIN_INACTIVE_SLOT1_FLASH_START
/bin/bcm_flasher /tmp/leon36-rmerlin1029a2.pkgtb
sync
