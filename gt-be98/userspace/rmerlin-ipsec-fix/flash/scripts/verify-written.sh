...
root=$(head -c 78422016 /dev/ubi0_4 | sha256sum | cut -d ' ' -f 1)
...
test "$root" = 51a8002add90f8992c1e6b7f434beb9800cd866fb372eb93272407d35bf9be9f
...
test "$(cat /sys/class/ubi/ubi0/avail_eraseblocks)" = 1
