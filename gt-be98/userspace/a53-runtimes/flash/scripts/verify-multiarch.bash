...
server.errorlog = "/tmp/leon-a53-flash-verify/lighttpd-test.log"
server.pid-file = "/tmp/leon-a53-flash-verify/lighttpd-test.pid"
...
echo A53_RUNTIME_LIVE_LIBRARIES_PASS
