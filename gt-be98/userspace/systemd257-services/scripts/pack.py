...
p = argparse.ArgumentParser(); p.add_argument('--revision', default='systemd257-v5'); p.add_argument('--services-label',default='services257-v5'); args = p.parse_args()
...
image = r / 'candidate/GT-BE98_leon36-systemd257-services_zstd22.pkgtb'
...
print('SYSTEMD257_CANDIDATE_PACKED', sha(image))
