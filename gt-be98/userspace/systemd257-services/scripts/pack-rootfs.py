...
manifest = {'image': a.output.name, 'bytes': len(image), 'sha256': fit.sha(image),
            ...
            'rootfs_block_size': policy['rootfs_block_size'], 'rootfs_sort': 'file type/ELF architecture, systemd family first, decreasing size', 'tailends': True, 'kernel_compression': 'lzo',
            ...
            'commit_requested': False, 'capacity_observation': 'router-readonly-capacity.txt: 1 free plus slot1 107+626; recheck before flashing', 'payloads': record}
