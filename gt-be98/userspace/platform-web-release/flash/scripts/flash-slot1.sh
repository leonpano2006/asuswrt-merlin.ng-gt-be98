...
test "$(sha256sum /tmp/leon10.pkgtb | cut -d ' ' -f 1)" = a238490efef12fdee0b2ba4780b2f2dd34eba338edd90e2a82b43746df6e697d
test "$(wc -c < /tmp/leon10.pkgtb)" = 90709068
/bin/fc status | grep 'HW Acceleration <Enabled>'
echo SYSTEMD257_INACTIVE_SLOT1_FLASH_START
/bin/bcm_flasher /tmp/leon10.pkgtb
sync
