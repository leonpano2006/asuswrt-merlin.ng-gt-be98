...
root=$(head -c 78553088 /dev/ubi0_4 | sha256sum | cut -d ' ' -f 1)
...
test "$root" = d54468045bf1b6808282def418d1d12a7b8eff777e9401d9d7d641ce9a213be2
...
test "$(cat /sys/class/ubi/ubi0/avail_eraseblocks)" = 0
