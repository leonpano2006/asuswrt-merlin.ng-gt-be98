#!/usr/bin/env python3
"""Prepare the complete queued rootfs: NVRAM fix, armel multiarch, GCC 15 libraries."""
import argparse
import hashlib
import json
