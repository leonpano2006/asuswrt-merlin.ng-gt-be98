...
test "$(sha256sum /tmp/leon36-usrmerge-run.pkgtb | cut -d ' ' -f 1)" = 1452a5da6e7edcecd211fa85deef99aa2b6a007232f074911eb2dc4c5e5cc1da
/bin/fc status | grep 'HW Acceleration <Enabled>'
echo USRMERGE_INACTIVE_SLOT1_FLASH_START
/bin/bcm_flasher /tmp/leon36-usrmerge-run.pkgtb
sync
echo USRMERGE_INACTIVE_SLOT1_FLASH_OK
bcm_bootstate
