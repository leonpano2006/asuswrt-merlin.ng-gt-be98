...
p.add_argument('--usrmerge-scripts', type=Path, required=True)
p.add_argument('--runtime-probe', type=Path, required=True)
...
files = {
    ...
    'userspace-smoke.sh': a.usrmerge_scripts / 'userspace-smoke.sh',
    'runtime-probe': a.runtime_probe,
