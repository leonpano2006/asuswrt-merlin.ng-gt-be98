...
root=$(head -c 78282752 /dev/ubi0_4 | sha256sum | cut -d ' ' -f 1)
...
test "$root" = 8df7322e87b846470bb6d3306f8ac78ab37ecaae63257cfb54c0b500ce22dc9b
...
test "$(cat /sys/class/ubi/ubi0/avail_eraseblocks)" = 2
