...
test "$(sha256sum /usr/share/leon-upstream.json | cut -d " " -f1)" = e2e9bc1936eb988b835baff44513a62525c3ffe57f55ba9cbbc78f7f840b0631
...
test "$(sha256sum /usr/sbin/rc | cut -d " " -f1)" = 0e09d9bcbc4ebd312ac8bc759f2b5ea845d74967222b7c21eaaded954df069d6
...
test "$(sha256sum /usr/libexec/leon-service-exec | cut -d " " -f1)" = dbff3539b9fd73bbb96cb9426d9475ff74fc42d16d0c64293a6b536e751e8781
test "$(sha256sum /usr/libexec/leon-service-owner-check | cut -d " " -f1)" = 36e7021dbdf445b0ab8280bb791c065ae4c9ceb900d498e02f729e68f8511b89
test "$(sha256sum /usr/lib/systemd/system/asus-sshd.service | cut -d " " -f1)" = a457f73ba9723ac1271ab5be5951dcef65f2cad82632b76c850ebbb1fe30e089
