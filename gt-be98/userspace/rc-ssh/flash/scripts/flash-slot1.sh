...
test "$(sha256sum /tmp/leon8.pkgtb | cut -d ' ' -f 1)" = 4270e9a5ff1d04cee10b18cdd8721774fe47b4106218f93e941bb2b23310fe03
test "$(wc -c < /tmp/leon8.pkgtb)" = 90700876
/bin/fc status | grep 'HW Acceleration <Enabled>'
echo SYSTEMD257_INACTIVE_SLOT1_FLASH_START
/bin/bcm_flasher /tmp/leon8.pkgtb
sync
