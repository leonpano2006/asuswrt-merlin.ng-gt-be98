...
for unit in asus-sshd.service asus-rc.service asus-haveged.service asus-crond.service asus-infosvr.service asus-cron-cleanup.service leon-local-ready.service; do test "$(systemctl is-active "$unit")" = active; done
...
/usr/bin/grep -q '3006.102.9-beta1-leon8' /usr/share/leon-upstream.json
...
test -f /run/leon8-live-features-passed
umask 077
printf 'Physical leon8 service/web/runtime/USB/acceleration acceptance checks passed; firmware remains uncommitted.\n' > /run/leon-systemd-trial/accepted
