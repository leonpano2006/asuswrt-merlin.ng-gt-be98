...
assert fit.sha(original) == '1452a5da6e7edcecd211fa85deef99aa2b6a007232f074911eb2dc4c5e5cc1da'
assert fit.sha(root) == '9d13b0b5789843e691cf08f2083c189dbc61f48eeb5d433795183e455b4aa026'
...
manifest = {'image': a.output.name, 'bytes': len(image), 'sha256': fit.sha(image),
            ...
            'commit_requested': False, 'payloads': record}
