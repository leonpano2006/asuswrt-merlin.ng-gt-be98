...
test "$(head -c 75804672 /dev/ubi0_4 | sha256sum | cut -d ' ' -f 1)" = 9d13b0b5789843e691cf08f2083c189dbc61f48eeb5d433795183e455b4aa026
...
echo ARMEL_MULTIARCH_LIVE_PATHS_SERVICES_KERNEL_FALLBACK_PASS
