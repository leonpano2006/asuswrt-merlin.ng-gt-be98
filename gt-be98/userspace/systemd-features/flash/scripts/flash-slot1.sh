...
test "$(sha256sum /tmp/leon7.pkgtb | cut -d ' ' -f 1)" = 283f2a0eb571a50e536a002934682e0bcea6949aad0a800c0df595fe55ac8da5
test "$(wc -c < /tmp/leon7.pkgtb)" = 90700876
/bin/fc status | grep 'HW Acceleration <Enabled>'
echo SYSTEMD257_INACTIVE_SLOT1_FLASH_START
/bin/bcm_flasher /tmp/leon7.pkgtb
sync
