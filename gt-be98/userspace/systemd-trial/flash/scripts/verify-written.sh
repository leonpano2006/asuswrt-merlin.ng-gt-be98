...
root=$(head -c 76701696 /dev/ubi0_4 | sha256sum | cut -d ' ' -f 1)
...
test "$root" = d5d6958ce3ea2e08d52d2891214b40c93fc70b9129b7127f70cabf80ebef80ad
...
test "$(cat /sys/class/ubi/ubi0/avail_eraseblocks)" = 14
