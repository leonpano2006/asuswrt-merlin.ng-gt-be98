...
run('armel','signal-mask-probe',[r/'tests/signal-mask-probe.c'])
...
import shutil
shutil.copy2(vendor/'libovpn.so',out/'libovpn-stock.so')
run('armel','ovpn-role-probe',[r/'tests/ovpn-role-probe.c'],['-Wl,--export-dynamic','-ldl'])
run('armel','ovpn-no-manager-probe',[r/'tests/ovpn-role-probe.c'],['-DNO_MANAGER_EXPORT','-Wno-unused-variable','-Wl,--export-dynamic','-ldl'])
