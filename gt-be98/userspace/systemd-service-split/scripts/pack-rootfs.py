...
manifest = {'image': a.output.name, 'bytes': len(image), 'sha256': fit.sha(image),
            ...
            'rootfs_block_size': policy['rootfs_block_size'], 'tailends': True, 'kernel_compression': 'lzo',
            ...
            'commit_requested': False, 'capacity_observation': 'storage-layout-20260916: 12 free plus slot1 107+615; recheck before flashing', 'payloads': record}
