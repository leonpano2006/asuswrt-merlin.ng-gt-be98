...
system.wlBandSeq = (() => {
    ...
    for (let i = 0; i < nBandArray.length; i++) {
        ...
        wlObj[wlIfIndex].bw240Value = _nvram[`${wlIfIndex}_bw_240`];
            ...
            if (wlIfIndex === "5g1" || wlIfIndex === "5g2") {
                ...
                chanspecs.forEach((element) => {
                    ...
                    if (element.indexOf("/240") !== -1) {
                        ...
                        if (wlObj[wlIfIndex].ch240MHz[_ch].length === 0) {
                            wlObj[wlIfIndex].ch240MHz[_ch].push(element.split("/240")[0]);
                        }
                    }
                });
            }
