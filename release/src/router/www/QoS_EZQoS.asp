...
<head>
    ...
    <script>
        ...
        var qos_bw_rulelist = "<% nvram_get("
        qos_bw_rulelist
        "); %>".replace(/&#62/g, ">").replace(/&#60/g, "<");
        ...
        function initial() {
            ...
            setTimeout(function () {
                document.getElementById("qoe_iframe").setAttribute("src", "/pages/qoe_ui3.html");
            ...
            const _nvram = httpApi.nvramGet(['qos_enable', 'ark_qoe_enable', 'qos_type', 'wan' + active_wan_unit + '_proto'], true);
            ...
            const wan_proto = _nvram['wan' + active_wan_unit + '_proto'];
            const hw_aqm_proto_support = (wan_proto == "dhcp" || wan_proto == "static" || wan_proto == "bridge");
            ...
            if (iphoneSwitchStatus) {
                ...
                if (ark_qoe_support) {
                    document.getElementById('qoe_type').style.display = "";
                    document.querySelector('label[for="qoe_type"]').style.display = "";
                    document.getElementById('int_type').style.display = "none";
                    document.getElementById('int_type_link').style.display = "none";
                } else if (adaptiveqos_support) {
                    document.getElementById('qoe_type').remove();
                    document.querySelector('label[for="qoe_type"]').remove();
            ...
            if (ark_qoe_support) {
                document.getElementById('switch_title').innerHTML = "<#Adaptive_QoE#>";
                document.getElementById('content_title').innerHTML = "<#Adaptive_QoE#>";
                document.getElementById('function_int_desc').style.display = "none";
                document.getElementById('qoe_desc').style.display = "";
            }

            if (ark_qoe_support && ark_qoe_enable) {
                document.getElementById('settingSelection').style.display = "none";
            } else if (adaptiveqos_support) {
                if (!ark_qoe_support) {
                    document.getElementById('switch_title').innerHTML = "<#Adaptive_QoS#>";
                    document.getElementById('content_title').innerHTML = "<#Adaptive_QoS#>";
                }

                const shouldShowSettings = document.form.qos_enable.value == "1" && qos_type == 0;
                document.getElementById('settingSelection').style.display = shouldShowSettings ? "" : "none";
                ...
                const isTraditional = qos_type == 0;
                document.getElementById('settingSelection').style.display = isTraditional ? "" : "none";
        ...
        function validForm() {
            ...
            if (document.form.qos_enable.value == 0 && document.form.qos_enable_orig.value == 0) {
                if (geforceNow_support || document.form.ark_qoe_enable.value) {
            ...
            if (document.form.qos_enable.value == "1") {
                ...
                if (qos_type != 2) {	//not Bandwidth Limiter
                    ...
                    if ((((qos_type == 1  || qos_type == 9) && document.form.bw_setting_name[1].checked == true) || qos_type == 0 || qos_type == 3 || qos_type == 8) && (document.form.obw.value.length == 0 || document.form.obw.value == 0)) {		// To check field is 0 && Traditional QoS
                    ...
                    if ((((qos_type == 1  || qos_type == 9) && document.form.bw_setting_name[1].checked == true) || qos_type == 0 || qos_type == 3) && (document.form.ibw.value.length == 0 || document.form.ibw.value == 0)) {		// To check field is 0 && Traditional QoS
                        alert("<#QoS_invalid_zero#>");
                        error_ibw++;
                    ...
                    if (mtwancfg_support && wans_flag == "1") {
                        ...
                        if ((((qos_type == 1  || qos_type == 9) && document.form.bw_setting_name[1].checked == true) || qos_type == 0 || qos_type == 3) && (document.form.obw1.value.length == 0 || document.form.obw1.value == 0)) {		// To check field is 0 && Traditional QoS
                            alert("<#QoS_invalid_zero#>");
                            error_obw1++;
                        ...
                        if ((((qos_type == 1  || qos_type == 9) && document.form.bw_setting_name[1].checked == true) || qos_type == 0 || qos_type == 3) && (document.form.ibw1.value.length == 0 || document.form.ibw1.value == 0)) {		// To check field is 0 && Traditional QoS
                            alert("<#QoS_invalid_zero#>");
                            error_ibw1++;
        ...
        function determineActionScript() {
            if (geforceNow_support && document.form.qos_enable.value == "0" && document.form.qos_enable_orig.value == "0" &&
                ...
                if (isSupport("gtbooster")) {
                    document.form.action_wait.value = "15";
                    document.form.action_script.value = "restart_ark;restart_qos;restart_firewall;";
                } else {
        ...
        function change_qos_type(value) {
            ...
            if (value == 0) {		//Traditional QoS
                ...
                document.getElementById('hw_aqm_type').checked = false;
                document.getElementById('bw_limit_type').checked = false;
                document.getElementById('bandwidth_setting_tr').style.display = (based_modelid === 'GT-BE98') ? "none" : "";
                if (geforceNow_support)
                    document.getElementById('GeForce_type').checked = false;
                //if(router_boost_support)
                //  document.getElementById('router_boost_tr').style.display = "";
                ...
                if(based_modelid === "GT-BE98" || document.getElementById("auto").checked){
                    show_up_down(0);
                } else {
                    show_up_down(1);
                }
                ...
                document.getElementById('list_table').style.display = "none";
                show_up_down(0);
                document.getElementById('qoe_iframe').style.display = "block";
                if (codel_support) {
                    document.getElementById('qos_overhead_tr').style.display = "";
                }
                if (cake_support) {
                ...
                document.form.action_wait.value = "<% get_default_reboot_time(); %>";
                show_settings("NonAdaptive");
                document.getElementById('qos_apply_btn').style.display = "none";
        ...
        function register_overHint() {
            ...
            document.getElementById('2').onmouseout = function () {
                nd();
            }
            document.getElementById('3').onmouseover = function () {
                overHint(93);
            }
            document.getElementById('3').onmouseout = function () {
                nd();
            }
            document.getElementById('4').onmouseover = function () {
                overHint(94);
            }
            document.getElementById('4').onmouseout = function () {
                nd();
            }
            document.getElementById('5').onmouseover = function () {
                overHint(95);
            }
            document.getElementById('5').onmouseout = function () {
                nd();
            }
            document.getElementById('6').onmouseover = function () {
                overHint(96);
            }
            document.getElementById('6').onmouseout = function () {
                nd();
            }
            if (document.getElementById('7')) {
                ...
                document.getElementById('7').onmouseout = function () {
                    nd();
                }
            }
        }
        ...
        <td valign="top">
                    ...
                    <form method="post" name="PriorityForm" action="/start_apply.htm" target="hidden_frame">
                        ...
                        <tr>
                            <div style="margin-left:30px; margin-top:10px;">
                                <div class="formfontdesc" style="line-height:20px;font-size:14px;">
                                    <#Adaptive_QoS_desc#>
                                </div>
                            </div>
                            <div style="margin:5px;*margin-left:-5px;width: 730px; height: 2px;"
                                 class="splitLine"></div>
                        </tr>
                        <tr>
                            <td valign="top">
                                ...
                                <div style="margin-bottom:10px;width:100%;text-align:center;">
                                    <input class="button_gen" id="btn_cancel_priority" type="button"
                                           onclick="cancel_priority_panel();" value="<#CTL_Cancel#>">
                                    <input class="button_gen" type="button" onclick="save_priority();"
                                           value="<#CTL_onlysave#>">
                                </div>
                            </td>
                        </tr>
            ...
            <form method="post" name="form" action="/start_apply.htm" target="hidden_frame">
                ...
                <table width="95%" border="0" align="left" cellpadding="0" cellspacing="0" class="FormTitle"
                       id="FormTitle" style="height:820px;">
                    <tr>
                        <td bgcolor="#4D595D" valign="top">
                            <div class="container">
                                ...
                                <table width="760px" border="0" cellpadding="4" cellspacing="0">
                                            ...
                                            <table width="100%">
                                                <tr style="height:30px;">
                                                    <td class="formfonttitle" align="left">
                                                        ...
                                                        <div class="formfonttitle_help"><i
                                                                onclick="show_feature_desc(`<#HOWTOSETUP#>`)"
                                                                class="icon_help"></i></div>
                                                    </td>
                                                    <td align="right">
                                                        <div style="margin-right:44px;margin-top:18px;">
                                                            <select id="settingSelection"
                                                                    onchange="switchPage(this.options[this.selectedIndex].value)"
                                                                    class="input_option">
                                                ...
                                                <table style="width:90%;">
                                                    <tr>
                                                        <td style="font-size: 14px;">
                                                            <div id="function_desc" class="formfontdesc"
                                                                 style="line-height:20px;">
                                                                <ul style="display: flex; flex-direction: column; gap: 10px;">
                                                                    <li id="function_int_desc">
                                                                        <div style="font-weight: bolder;font-size: 14px;">
                                                                            <#Adaptive_QoS#>
                                                                        </div>
                                                                        <div><#Adaptive_QoS_Desc_2#>
                                                                        </div>
                                                                    </li>
                                                                    <li id="qoe_desc" style="display: none">
                                                                        <div style="font-weight: bolder;font-size: 14px;">
                                                                            <#Adaptive_QoE#>
                                                                        </div>
                                                                        <div><#Adaptive_QoE_Desc#>
                                                                        </div>
                                                                    </li>
                                                                    <li id="qos_desc">
                                                                        <div style="font-weight: bolder;font-size: 14px;">
                                                                            <#EzQoS_type_traditional#>
                                                                        </div>
                                                                        <div><#Traditional_QoS_Desc#>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div style="font-weight: bolder;font-size: 14px;">
                                                                    ...
                                                                    <li id="cake_desc">
                                                                        ...
                                                                        <div>Automatic queue management algorithm that takes care of ensuring fairness in traffic queueing without requiring manual configuration.
                                                                        </div>
                                                                    </li>
                                                                    <li id="hw_aqm_desc">
                                                                        <div style="font-weight:bolder;font-size:14px;">
                                                                        ...
                                                                        <div>Hardware-accelerated Active Queue Management that shapes the upload queue in the network processor to reduce bufferbloat.
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table style="margin-left:3px;" width="95%" border="1" align="center"
                                                   cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"
                                                   class="FormTable">
                                                <tr id="GeForce_upnp" style="display: none;">
                                                    <th><#GeForce_NOW_itemname#></th>
                                                    <td colspan="2">
                                                        <input type="radio" name="nvgfn_enable" class="input" value="1"
                                                        <% nvram_match("nvgfn_enable", "1", "checked");%>><#checkbox_Yes#>
                                                        <input type="radio" name="nvgfn_enable" class="input" value="0"
                                                        <% nvram_match("nvgfn_enable", "0", "checked");%>><#checkbox_No#>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th id="switch_title"><#Adaptive_QoS#></th>
                                                    <td colspan="2">
                                                        <div class="left"
                                                             style="width:94px; float:left; cursor:pointer;"
                                                             id="radio_qos_enable"></div>
                                                        <div id="qos_enable_hint"
                                                             style="color:#FC0;margin:5px 0px 0px 100px;display:none">
                                                            <#QzQoS_note#>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr id="router_boost_tr" style="display:none">
                                                    <th>RouterBoost</th>
                                                    <td colspan="2">
                                                        <input id="rb_on" name="rb_toggle"
                                                               onClick="routerboost_enable_setting();" type="radio" <%nvram_match("rb_enable", "1","checked"); %>><label for="rb_on"><#CTL_Activate#></label>
                                                        <input id="rb_off" name="rb_toggle"
                                                               onClick="routerboost_enable_setting();" type="radio" <%nvram_match("rb_enable", "0","checked"); %>><label for="rb_off"><#CTL_Deactivate#></label>
                                                    </td>
                                                </tr>
                                                <tr id="qos_type_tr" style="display:none">
                                                    <th><#Type#></th>
                                                    <td colspan="3">
                                                        <input id="qoe_type" name="qos_type_radio" value="4"
                                                               onClick="change_qos_type(this.value);"
                                                               style="display:none;" type="radio" <% nvram_match("ark_qoe_enable", "1","checked"); %>><label style="display:none;"
                                                            for="qoe_type"><#Adaptive_QoE#></label>
                                                        <input id="int_type" name="qos_type_radio" value="1"
                                                               onClick="change_qos_type(this.value);"
                                                               style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link"
                                                                                                      class="hintstyle"
                                                                                                      style="display:none;"
                                                                                                      href="javascript:void(0);"
                                                                                                      onClick="openHint(20, 5);"><label
                                                            for="int_type"><#Adaptive_QoS#></label></a>
                                                        <input id="trad_type" name="qos_type_radio" value="0"
                                                               onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle"
                                                                                                      href="javascript:void(0);"
                                                                                                      onClick="openHint(20, 6);"><label
                                                            for="trad_type"><#EzQoS_type_traditional#></label></a>
                                                        <input id="bw_limit_type" name="qos_type_radio" value="2"
                                                               onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle"
                                                                                                      href="javascript:void(0);"
                                                                                                      onClick="openHint(20, 7)"><label
                                                            for="bw_limit_type"><#Bandwidth_Limiter#></label></a>
                                                        <span id="GeForceNow_item" style="display: none;"><input
                                                                id="GeForce_type" name="qos_type_radio" value="3"
                                                                onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "3","checked"); %>><a
                                                                class="hintstyle" href="javascript:void(0);"><label
                                                                for="GeForce_type">GeForce NOW QoS</label></a></span>
                                                        <input id="cake_type" name="qos_type_radio" value="9"
                                                               onClick="change_qos_type(this.value);" style="display: none;" type="radio" <% nvram_match("qos_type", "9","checked"); %>><a id="cake_type_link"\
                                                                                                      style="display:none;" class="hintstyle"
                                                                                                      href="javascript:void(0);"
                                                                                                      onClick="openHint(50, 32);"><label
                                                            for="cake_type">Cake</label></a>
                                                        <input id="hw_aqm_type" name="qos_type_radio" value="8"
                                                               onClick="change_qos_type(this.value);" style="display: none;" type="radio" <% nvram_match("qos_type", "8","checked"); %>><label
                                                            for="hw_aqm_type" style="display:none;">HW AQM</label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="bandwidth_setting_tr" style="display:none">
                                                    ...
                                                    <td colspan="2">
                                                        <input id="auto" name="bw_setting_name"
                                                               onClick="bandwidth_setting();" type="radio"><label
                                                            for="auto"><#Auto_Setting_btn#></label>
                                                        <input id="manu" name="bw_setting_name"
                                                               onClick="bandwidth_setting();" type="radio"><label
                                                            for="manu"><#Manual_Setting_btn#></label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="upload_tr">
                                                    <th><a class="hintstyle" href="javascript:void(0);"
                                                           onClick="openHint(20, 2);"><#upload_bandwidth#></a></th>
                                                    <td>
                                                        <input type="text" maxlength="10" id="obw" name="obw"
                                                               onKeyPress="return validator.isNumberFloat(this,event);"
                                                               class="input_15_table" value="" autocorrect="off"
                                                               autocapitalize="off">
                                                ...
                                                <tr id="download_tr" style="display:none">
                                                    <th><a class="hintstyle" href="javascript:void(0);"
                                                           onClick="openHint(20, 2);"><#download_bandwidth#></a></th>
                                                    <td>
                                                        <input type="text" maxlength="10" id="ibw" name="ibw"
                                                               onKeyPress="return validator.isNumberFloat(this,event);"
                                                               class="input_15_table" value="" autocorrect="off"
                                                               autocapitalize="off">
                                                        <label style="margin-left:5px;">Mb/s</label>
                                                ...
                                                <tr id="upload2_tr" style="display:none">
                                                    <th><a class="hintstyle" href="javascript:void(0);"
                                                           onClick="openHint(20, 2);"><#upload_bandwidth#></a></th>
                                                    <td>
                                                        <input type="text" maxlength="10" id="obw1" name="obw1"
                                                               onKeyPress="return validator.isNumberFloat(this,event);"
                                                               class="input_15_table" value="" autocorrect="off"
                                                               autocapitalize="off">
                                                        <label style="margin-left:5px;">Mb/s</label>
                                                ...
                                                <tr id="download2_tr" style="display:none">
                                                    <th><a class="hintstyle" href="javascript:void(0);"
                                                           onClick="openHint(20, 2);"><#download_bandwidth#></a></th>
                                                    <td>
                                                        <input type="text" maxlength="10" id="ibw1" name="ibw1"
                                                               onKeyPress="return validator.isNumberFloat(this,event);"
                                                               class="input_15_table" value="" autocorrect="off"
                                                               autocapitalize="off">
                                                        <label style="margin-left:5px;">Mb/s</label>
                                ...
                                <table id="quick_setup_desc" width="98%" border="0"
                                       style="margin-top:5px;margin-left:5px;display:none;">
                                    <tr>
                                        <td height="30" align="left" valign="top" bgcolor="#4D595D">
                                            <div class="formfontdesc" style="line-height:20px;font-size:14px;">
                                                <#Adaptive_QoS_Desc_3#>
                                    ...
                                    <div style="display:flex;align-items: center;justify-content: center;">
                                        <div style="width: 120px;height:174px;">
                                            <div style="display:flex;height:132px;">
                                                <div id="Game" onclick="clickEvent(this);" onmouseover="overHint(86);"
                                                     onmouseout="nd();"></div>
                                            </div>
                                        ...
                                        <div style="width: 120px;height:174px;">
                                            <div style="display:flex;height:132px;">
                                                <div id="Media" onclick="clickEvent(this);" onmouseover="overHint(87);"
                                                     onmouseout="nd();"></div>
                                            </div>
                                        ...
                                        <div style="width: 120px;height:174px;">
                                            <div style="display:flex;height:132px;">
                                                <div id="Web" onclick="clickEvent(this);" onmouseover="overHint(88);"
                                                     onmouseout="nd();"></div>
                                            </div>
                                        ...
                                        <div style="width: 120px;height:174px;">
                                            <div style="display:flex;height:132px;">
                                                <div id="eLearning" onclick="clickEvent(this);"
                                                     onmouseover="overHint(104);" onmouseout="nd();"></div>
                                            </div>
                                            <div class="Quick_Setup_title"><#Adaptive_eLearning#></div>
                                        </div>
                                        <div style="width: 120px;height:174px;">
                                            <div style="display:flex;height:132px;">
                                                <div id="videoConference" onclick="clickEvent(this);"
                                                     onmouseover="overHint(103);" onmouseout="nd();"></div>
                                            </div>
                                            <div class="Quick_Setup_title"><#Adaptive_Message#></div>
                                        </div>
                                        <div style="width: 120px;height:174px;">
                                            <div style="display:flex;height:132px;">
                                                <div id="Customize" onclick="clickEvent(this);set_priority('on');"
                                                     onmouseover="overHint(85);" onmouseout="nd();"></div>
                                            </div>
                                ...
                                <table id="list_table" width="94%" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <iframe id="qoe_iframe" style="display:none; width: 100%; height: 600px"
                                        frameborder="0"></iframe>

                                <table id="qos_apply_btn" width="100%">
                                    <tr>
                                        <td height="50">
                                            <div style=" *width:136px;margin-left:300px;" class="titlebtn"
                                                 align="center" onClick="submitQoS();"><span><#CTL_apply#></span></div>
                                        </td>
                                    </tr>
                                </table>
